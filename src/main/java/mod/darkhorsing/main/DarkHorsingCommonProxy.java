...
public class DarkHorsingCommonProxy { //implements IGuiHandler (THIS IS IMPORTANT, CANNOT BE A PROXY/GUI HANDLER WITHOUT THIS!!)
	...
	//Withered Bone
	LanguageRegistry.addName(DarkHorsing.Withered_Bone, "Withered Bone");
